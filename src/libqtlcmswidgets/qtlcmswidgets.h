// $Id: qtlcmswidgets.h,v 1.7 2006/03/22 00:32:18 hvengel Exp $
...
public:
    ...
    BaseSelector(QString ThePrompt, QString DefaultDir, QString Mask = "*.*", BOOL lUseLineEdit = FALSE,  BOOL showFileDialog = TRUE,
...
public:
    ...
    IT8Selector(QWidget* parent=0, const char* name=0, WFlags f=0) :
        BaseSelector(tr("Target"), "", "*.txt *.TXT *.IT8 *.it8 *.q60 *.Q60", FALSE, FALSE, parent, name, f) {}               
...
class IT8SelectorWithFileDialog: public BaseSelector {

    Q_OBJECT

    public:

    IT8SelectorWithFileDialog(QWidget* parent=0, const char* name=0, WFlags f=0) :
        BaseSelector(tr("IT8 Target"), "", "*.txt *.TXT *.IT8 *.it8 *.q60 *.Q60", FALSE, TRUE, parent, name, f) {}               
...
public:
    ...
    IT8FileSelector(QWidget* parent=0, const char* name=0, WFlags f=0) :
        BaseSelector(tr("IT8 target"), "", "*.*", TRUE, TRUE, parent, name, f) {}                
...
public:
        ...
        ICCProfileSelector(QWidget* parent=0, const char* name=0, WFlags f=0) :
                BaseSelector("ICC Profile", "", "*.icc;*.icm", FALSE, TRUE,  parent, name, f) 
...
protected:
    cmsxCIETonge& operator=( const cmsxCIETonge& rhs );
...
protected:
    cmsxDrawCurve& operator=( const cmsxDrawCurve& rhs );
	int pixcols, pixrows;
