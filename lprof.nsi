...
!define setup "lprof-setup.exe"
 
; change this to wherever the files to be packaged reside
!define srcdir "."
 
!define company "lprof.sourceforge"
 
!define prodname "LProf"
!define exec "bin\lprof.exe"
...
; license text file
!define licensefile "README"
 
; icons must be Microsoft .ICO files
!define icon "data\icons\lprof.ico"
